var debug = require('debug')('nightwatch:testcase');
...
function TestCase(suite, testFn, numRetries, maxRetries) {
  debug('Constructing TestCase:', testFn, 'numRetries:', numRetries, 'maxRetries:', maxRetries);
  this.suite = suite;
  this.testFn = testFn;
  ...
  this.suite
    ...
    .then(function() {
      ...
      try {
        ...
        debug('err while running test case', err);
